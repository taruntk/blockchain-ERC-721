...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(await instance.lookUptokenIdToStarSymbol.call(starId), 'AWS');
...
it('lets 2 users exchange stars', async() => {
    ...
    let starId1 = 7;
    let starId2 = 8;
    await instance.createStar('Awesome Star!', "AWS", starId1, {from: user1});
    await instance.createStar('Awesome Star2!', "A2S", starId2, {from: user2});
